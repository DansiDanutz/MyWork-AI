      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-gray-950/80 backdrop-blur-sm border-b border-gray-100 dark:border-gray-800">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-white">Task Tracker</span>
          </div>
          <div className="flex items-center gap-4">
            <Link href="#features" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hidden sm:block">
              Features
            </Link>
            <Link href="#how-it-works" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hidden sm:block">
              How it Works
            </Link>
            {session?.user ? (
              <Link
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
              Stop managing tasks.
              <br />
              <span className="text-blue-600 dark:text-blue-400">Start finishing them.</span>
            </h1>
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
              A minimal, fast task tracker that gets out of your way.
              Create tasks, attach files, swipe to complete. That&apos;s it.
            </p>
                ...
                <div className="flex gap-6">
                  ...
                  <div className="hidden sm:block w-48 space-y-4">
                    <div className="flex items-center gap-2 p-2 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                      ...
                      <span className="text-sm font-medium text-blue-700 dark:text-blue-300">All Tasks</span>
                    </div>
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="px-3 py-1 bg-blue-600 text-white text-sm rounded-lg">+ New</div>
                    </div>
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-xl border-l-4 border-green-500">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <p className="text-gray-500 dark:text-gray-400 line-through">Review pull request</p>
                          <span className="text-xs text-gray-400">Completed 2h ago</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-white dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <p className="text-gray-900 dark:text-white font-medium">Finish landing page design</p>
                          <div className="flex items-center gap-2 mt-2">
                            <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 text-xs rounded">Design</span>
                    ...
                    <div className="p-4 bg-white dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <p className="text-gray-900 dark:text-white font-medium">Deploy to production</p>
                          <div className="flex items-center gap-2 mt-2">
                            <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 text-xs rounded">DevOps</span>
      ...
      <section className="py-16 px-4 bg-gray-50 dark:bg-gray-900/50">
        <div className="container mx-auto max-w-4xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-2">100%</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Free to use</div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-2">&lt;2s</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Page load time</div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-2">0</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Ads or tracking</div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-2">1-click</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">GitHub login</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Built for developers who want to track tasks without the complexity of enterprise tools.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Swipe right to complete. Swipe left to delete. Works perfectly on any device.
              </p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                One-click login with your GitHub account. No passwords to remember.
              </p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Color-coded tags to organize tasks your way. Filter and search instantly.
              </p>
            </div>
            ...
            <div className="p-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Find any task in milliseconds. Search by title, description, or tags.
              </p>
            </div>
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Click the button, authorize with GitHub, and you&apos;re in. No forms, no verification emails.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Hit the + button, type what you need to do, add optional tags and files. Done.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  On mobile, swipe right to mark done. On desktop, just click the checkbox. Satisfying either way.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-gray-900 dark:text-white">Task Tracker</span>
            </div>

            <div className="flex items-center gap-6 text-sm text-gray-600 dark:text-gray-400">
              <Link href="/status" className="hover:text-gray-900 dark:hover:text-white">
                Status
              </Link>
              <a href="https://github.com/DansiDanutz/MyWork-AI" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 dark:hover:text-white">
                GitHub
              </a>
