...
<objective>
Create file display components for showing thumbnails, file lists, and preview functionality.

Purpose: Users need to see their attached files with visual previews for images and clear file type indicators for documents. This provides the visual feedback that makes file attachments useful.

Output: FileThumbnail.tsx, FileList.tsx, FilePreview.tsx components, thumbnail serving endpoint
</objective>
...
<task type="auto">
  ...
  <files>src/shared/components/FileThumbnail.tsx, src/shared/components/FilePreview.tsx</files>
  <action>
...
<task type="auto">
  ...
  <files>src/shared/components/FileList.tsx, src/shared/components/index.ts</files>
  <action>
