...
<svg className={`${className} ${color}`} fill="none" viewBox="0 0 24 24"
stroke="currentColor">
  {isPdf ? (
...
14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002
2z" />
...
```
// Archive icon
<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5
8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9
4h4" />
...
<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7
21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2
...
```javascript
className="bg-zinc-900 rounded-lg shadow-xl max-w-4xl max-h-[90vh] w-full
mx-4 flex flex-col"
...
```
  ...
  <p className="text-zinc-400 mb-4">Preview not available for this file
  type</p>
  <button
...
{files.length > 4 && (
  ...
  bg-zinc-800 border border-zinc-700 text-zinc-400 text-xs">
...
<div
  key={file.id}
  className={`flex items-center gap-3 p-3 rounded-lg bg-zinc-800/50 border
  border-zinc-700 ${
