...
- Audit/secret scan passes.
- Support contact and update policy are set.
...
- Support policy (email, SLA, update frequency)
...
- [ ] Setup script or clear commands (install, migrate, seed)
- [ ] Basic tests or smoke test documented
- [ ] No secrets in repo (run gitleaks or manual check)
...
4. Provide a minimal launch checklist and verify the flow end-to-end.
